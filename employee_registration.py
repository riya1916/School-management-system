...
def add():
    ...
    if (employee.get() == '' or employeename.get() == '' or father.get() == ''
        ...
        return
    value = (employee.get(), employeename.get(), father.get(),
...
# Heading
header = Label(headingframe, bd=20, text="EMPLOYEE REGISTRATION", fg='white', bg='#3498db', font=("times new roman", 30))
...
employeename = Label(app1, text="Teacher's Name")
...
employeename.grid(row=1, column=3, pady=6, padx=15)
...
employeenameentry = Entry(app1, textvariable=employeenamevalue, width=30)
...
employeenameentry.grid(row=1, column=4)
...
'''Employee No, CNIC No, Gender, Present Grade,Teacher's Name,
 Date Of Birth, Contact No, Qualification, Father Name, Date of Appointment, Email Address, 
 Address'''

columns = ("Employee No", "Employee name", "Father Name", "CNIC No",
...
teacher_table.heading("Employee name", text="Employee name")
...
teacher_table.column("Employee name", width=150, anchor=CENTER)
