...
# Heading
header = Label(headingframe, bd=20, text="TEACHER PROFILE", fg='white', bg='#3498db', font=("times new roman", 30))
header.pack(side=TOP, fill=X)

f1 = Frame(root, padx=150)
f1.place(x=60, y=150, width=1100, height=300)

my_pic = ImageTk.PhotoImage(file="exam1.png")
...
Button(f2, text="EXAM", command=exam, bg="#E6E6FA", pady=3, padx=50, font=("lucida", 10, "bold")).grid(row=1, column=1, padx=50)
